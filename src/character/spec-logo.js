...
export const SpecLogo = {
  // Your hand-coded SPEC dog design with Specify purple-to-blue gradient
  pixelDog: `                                         ${chalk.hex('#A855F7')('██████          ██████')}
                                       ${chalk.hex('#A855F7')('██▓▓▓▓▓▓██████████▓▓▓▓▓▓██')}
                                       ${chalk.hex('#9333EA')('██▓▓▓▓██          ██▓▓▓▓██')}
                                       ${chalk.hex('#7C3AED')('██▓▓████    ▓▓▓▓▓▓████▓▓██')}
   ${chalk.hex('#A855F7')('███████╗')}${chalk.hex('#9333EA')('██████╗ ')}${chalk.hex('#7C3AED')('███████╗')}${chalk.hex('#6366F1')(' ██████╗')}     ${chalk.hex('#6366F1')('██  ██  ██▓▓██▓▓██  ██')}
   ${chalk.hex('#A855F7')('██╔════╝')}${chalk.hex('#9333EA')('██╔══██╗')}${chalk.hex('#7C3AED')('██╔════╝')}${chalk.hex('#6366F1')('██╔════╝')}         ${chalk.hex('#4F46E5')('██    ▓▓▓▓▓▓██')}
   ${chalk.hex('#A855F7')('███████╗')}${chalk.hex('#9333EA')('██████╔╝')}${chalk.hex('#7C3AED')('█████╗  ')}${chalk.hex('#6366F1')('██║     ')}       ${chalk.hex('#4F46E5')('██              ██')}
   ${chalk.hex('#A855F7')('╚════██║')}${chalk.hex('#9333EA')('██╔═══╝ ')}${chalk.hex('#7C3AED')('██╔══╝  ')}${chalk.hex('#6366F1')('██║     ')}       ${chalk.hex('#4338CA')('██    ██████    ██')}
   ${chalk.hex('#A855F7')('███████║')}${chalk.hex('#9333EA')('██║     ')}${chalk.hex('#7C3AED')('███████╗')}${chalk.hex('#6366F1')('╚██████╗')}      ${chalk.hex('#4338CA')('██    ██████    ██')}
   ${chalk.hex('#A855F7')('╚══════╝')}${chalk.hex('#9333EA')('╚═╝     ')}${chalk.hex('#7C3AED')('╚══════╝')}${chalk.hex('#6366F1')(' ╚═════╝')}      ${chalk.hex('#3730A3')('██              ██')}
                                            ${chalk.hex('#3730A3')('██    ██    ██')}
                                              ${chalk.hex('#EC4899')('████░░████')}
                                                ${chalk.hex('#EC4899')('██░░██')}
                                                ${chalk.hex('#EC4899')('██░░██')}
      ...
      ${chalk.hex('#A855F7')('🐕 Your Loyal Spec Kit Assistant')}
`,
