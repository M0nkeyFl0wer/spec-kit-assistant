...
export const SpecLogo = {
  // Clean simple design - just SPEC text with Specify gradient
  // Uses only basic ASCII for maximum compatibility
  pixelDog: chalk.white(`
    ╔════════════════════════════════════════════════════════════════════╗
    ║                                                                    ║
    ║   `) + chalk.hex('#00D9FF')('███████╗') + chalk.hex('#0099FF')('██████╗ ') + chalk.hex('#0099FF')('███████╗') + chalk.hex('#0066FF')(' ██████╗') + chalk.white(`                        ║
    ║   `) + chalk.hex('#00D9FF')('██╔════╝') + chalk.hex('#0099FF')('██╔══██╗') + chalk.hex('#0099FF')('██╔════╝') + chalk.hex('#0066FF')('██╔════╝') + chalk.white(`  🐕 Your Loyal Dog Assistant  ║
    ║   `) + chalk.hex('#00D9FF')('███████╗') + chalk.hex('#0099FF')('██████╔╝') + chalk.hex('#0099FF')('█████╗  ') + chalk.hex('#0066FF')('██║     ') + chalk.white(`                        ║
    ║   `) + chalk.hex('#00D9FF')('╚════██║') + chalk.hex('#0099FF')('██╔═══╝ ') + chalk.hex('#0099FF')('██╔══╝  ') + chalk.hex('#0066FF')('██║     ') + chalk.white(`                        ║
    ║   `) + chalk.hex('#00D9FF')('███████║') + chalk.hex('#0099FF')('██║     ') + chalk.hex('#0099FF')('███████╗') + chalk.hex('#0066FF')('╚██████╗') + chalk.white(`                        ║
    ║   `) + chalk.hex('#00D9FF')('╚══════╝') + chalk.hex('#0099FF')('╚═╝     ') + chalk.hex('#0099FF')('╚══════╝') + chalk.hex('#0066FF')(' ╚═════╝') + chalk.white(`                        ║
    ║                                                                    ║
    ║              `) + chalk.hex('#0099FF')('Spec-Driven Development Made Easy') + chalk.white(`                ║
    ║                                                                    ║
    ╚════════════════════════════════════════════════════════════════════╝
`),
