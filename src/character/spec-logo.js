...
export const SpecLogo = {
  // SPEC logo with dog - using same box-drawing characters that work!
  pixelDog: chalk.white(`
    ╔════════════════════════════════════════════════════════════════════╗
    ║                        `) + chalk.hex('#00D9FF')('╔═══╗    ╔═══╗') + chalk.white(`                         ║
    ║                        `) + chalk.hex('#00D9FF')('║   ╚════╝   ║') + chalk.white(`                         ║
    ║   `) + chalk.hex('#00D9FF')('███████╗') + chalk.hex('#0099FF')('██████╗ ') + chalk.hex('#0099FF')('███████╗') + chalk.hex('#0066FF')(' ██████╗  ') + chalk.hex('#0099FF')('║ ● ║  ║ ● ║') + chalk.white(`         ║
    ║   `) + chalk.hex('#00D9FF')('██╔════╝') + chalk.hex('#0099FF')('██╔══██╗') + chalk.hex('#0099FF')('██╔════╝') + chalk.hex('#0066FF')('██╔════╝  ') + chalk.hex('#0099FF')('╚═══╝  ╚═══╝') + chalk.white(`         ║
    ║   `) + chalk.hex('#00D9FF')('███████╗') + chalk.hex('#0099FF')('██████╔╝') + chalk.hex('#0099FF')('█████╗  ') + chalk.hex('#0066FF')('██║           ') + chalk.hex('#0066FF')('║   ║') + chalk.white(`              ║
    ║   `) + chalk.hex('#00D9FF')('╚════██║') + chalk.hex('#0099FF')('██╔═══╝ ') + chalk.hex('#0099FF')('██╔══╝  ') + chalk.hex('#0066FF')('██║           ') + chalk.hex('#0066FF')('╚═══╝') + chalk.white(`              ║
    ║   `) + chalk.hex('#00D9FF')('███████║') + chalk.hex('#0099FF')('██║     ') + chalk.hex('#0099FF')('███████╗') + chalk.hex('#0066FF')('╚██████╗      ') + chalk.hex('#0066FF')('║ ║ ║') + chalk.white(`              ║
    ║   `) + chalk.hex('#00D9FF')('╚══════╝') + chalk.hex('#0099FF')('╚═╝     ') + chalk.hex('#0099FF')('╚══════╝') + chalk.hex('#0066FF')(' ╚═════╝      ') + chalk.hex('#0066FF')('╚═╩═╝') + chalk.white(`              ║
    ║                                                                    ║
    ║              `) + chalk.hex('#0099FF')('🐕 Your Loyal Spec Kit Assistant') + chalk.white(`                  ║
    ║                                                                    ║
    ╚════════════════════════════════════════════════════════════════════╝
`),
