...
- SSH deployment to Remote-Server should be seamless and secure
...
├─────────────────────────────────────┤
│   Optional: Remote-Server SSH Deployment   │  ← Remote execution
└─────────────────────────────────────┘
```
...
- **Remote**: Remote-Server SSH for distributed work
...
- Mock Remote-Server SSH for local testing
...
- **SSH latency**: < 2s connection time to Remote-Server
